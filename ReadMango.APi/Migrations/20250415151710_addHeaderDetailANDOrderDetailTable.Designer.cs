...
namespace ReadMango.APi.Migrations
{
    ...
    [Migration("20250415151710_addHeaderDetailANDOrderDetailTable")]
    partial class addHeaderDetailANDOrderDetailTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReadMango.APi.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReadMango.APi.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("ReadMango.APi.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReadMango.APi.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReadMango.APi.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("ReadMango.APi.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("ReadMango.APi.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("ReadMango.APi.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("ReadMango.APi.Models.OrderHeader", b =>
                {
                    b.HasOne("ReadMango.APi.Models.Applicationuser", "User")
                        .WithMany()
